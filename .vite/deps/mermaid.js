import {
  selectSvgElement
} from "./chunk-JCIJ4F2U.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-OGBKGZGJ.js";
import {
  registerLayoutLoaders
} from "./chunk-F2IJJP3F.js";
import "./chunk-OYWDYELM.js";
import "./chunk-BJOPRS5H.js";
import "./chunk-YBBS4J7E.js";
import "./chunk-YHKP7A4K.js";
import "./chunk-QQZ6KMHJ.js";
import "./chunk-OUP3SMNF.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-FNME5ATL.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-NL3FCH5A.js";
import "./chunk-PMDE7N3F.js";
import {
  UnknownDiagramError,
  addDirective,
...
// node_modules/.deno/stylis@4.4.0/node_modules/stylis/src/Enum.js
var COMMENT = "comm";
var RULESET = "rule";
...
// node_modules/.deno/stylis@4.4.0/node_modules/stylis/src/Utility.js
var abs = Math.abs;
...
// node_modules/.deno/stylis@4.4.0/node_modules/stylis/src/Tokenizer.js
var line = 1;
var column = 1;
var length = 0;
var position = 0;
...
// node_modules/.deno/stylis@4.4.0/node_modules/stylis/src/Parser.js
...
// node_modules/.deno/stylis@4.4.0/node_modules/stylis/src/Serializer.js
...
// node_modules/.deno/stylis@4.4.0/node_modules/stylis/src/Middleware.js
...
// node_modules/.deno/mermaid@11.15.0/node_modules/mermaid/dist/mermaid.core.mjs
var id = "c4";
var detector = __name((txt) => {
  return /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(txt);
}, "detector");
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-AAUBKEIU-VTAHLZBW.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-TNCGU7S2.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-TEJ5UH35-URJG5H43.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-5PKNETVI.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-6RSMTGT7-MQJVT5QH.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-YSZULB3L.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-GLLQIBXQ.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-W4KKPZXB-QK2CDIKB.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-2RQKCTM6-KPMF2ITE.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-4Y6WPE33-FCEBUAS4.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-5ND4KB63.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-4FO5ZUOK-2XDCKT5B.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-Q7XG4LA2-KDH4I3YV.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-AJRCARHV-E2YNADE6.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-BHNVJYJU-MVXJ3XE5.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-JHISSGLW-UI4YPJVM.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-PNZ67QCA-RPKICDEB.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-RKZ34NQL-VVOHVXEM.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-WWRVKKFL.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-5OEKKPKP-XLAJEVXT.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-LMA3HP47-2XR3KNRH.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-AMWFALXA.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-GPEHLZMM-34MXZWAW.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-BF5Q3S6B.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-YZ5ITTXM.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-RZLOMA2V.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-YF4QCWOH-36T6TLG2.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-CIIHVFJN-XZEAHEOR.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-FDV3DBEU.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-2VFLDFMB.js");
